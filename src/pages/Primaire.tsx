...
export default function Primaire() {
  ...
  const categories = [
    {
      id: "french",
      title: t("primaire.french.title"),
      subjects: t("primaire.french.subjects"),
    },
    {
      id: "mathematics",
      title: t("primaire.mathematics.title"),
      subjects: t("primaire.mathematics.subjects"),
    },
    {
      id: "sciences",
      title: t("primaire.sciences.title"),
      subjects: t("primaire.sciences.subjects"),
    },
    {
      id: "socialStudies",
      title: t("primaire.socialStudies.title"),
      subjects: t("primaire.socialStudies.subjects"),
    },
  ];

  const sendEmail = async (data: typeof formData) => {
    try {
      const emailContent = `New Academy Session Booking from Primaire\n\nStudent Information:\n- Name: ${data.name}\n- Email: ${data.email}\n- Class: ${data.subject}\n- Preferred Date: ${data.date}\n- Preferred Time: ${data.time}\n- Message: ${data.message}\n\nTimestamp: ${new Date().toISOString()}`;
    ...
    <div className="min-h-screen bg-[#faf8f3]">
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-4xl font-playfair font-bold mb-12 text-gray-900">Subjects</h2>
